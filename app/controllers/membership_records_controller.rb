class MembershipRecordsController < ApplicationController
  ...
  private
    ...
    def membership_record_params
      params.require(:membership_record).permit(:membership_id, :lookup_id :membership_scheme, :membership_level, :add_ons, :membership_level_type, :membership_status, :start_date, :end_date, :last_renewed)
    end
end
